...
facebook.com
------------
Facebook полностью отказался от canvas фингерпринта. И очень активно использует замеры времени для фингерпринта браузера и пользователя.
По этой причине рекомендуем использовать :ref:`profiles-time-shifting` - эта технология позволит влиять на фингерпринты основанные на замерах времени.
...
.. tip::
   ...
   | По этой причине крайне рекомендует использовать :ref:`profiles-time-shifting`, что позволит качественно влиять на выше описанные замеры времени.
